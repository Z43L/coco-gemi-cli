...
console.log('packing coco ...');
const cliPackageDir = join('packages', 'cli');
rmSync(join(cliPackageDir, 'dist', 'coco-*.tgz'), { force: true });
execSync(`npm pack -w coco --pack-destination ./packages/cli/dist`, {
  stdio: 'ignore',
});
...
chmodSync(join(cliPackageDir, 'dist', `coco-${packageVersion}.tgz`), 0o755);
chmodSync(
