...
const OAUTH_CLIENT_ID_ENV = 'COCO_OAUTH_CLIENT_ID';
const OAUTH_CLIENT_SECRET_ENV = 'COCO_OAUTH_CLIENT_SECRET';
...
function getOauthClientCredentials(): { clientId: string; clientSecret: string } {
  ...
  if (!clientId || !clientSecret) {
    throw new FatalAuthenticationError(
      `OAuth client credentials are not configured. Set the environment variables ${OAUTH_CLIENT_ID_ENV} and ${OAUTH_CLIENT_SECRET_ENV} before attempting authentication.`,
    );
  }
